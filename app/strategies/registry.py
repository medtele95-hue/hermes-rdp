...
# GRAND_PLAN 2026-07-08 (décision SIMO) : BTCUSD# redevient un symbole
# officiel aux côtés de GOLD#. Les stratégies BTC sont ré-exécutables ;
# le verrou final reste demo_router.SYMBOL_ALLOWLIST = (GOLD#, BTCUSD#).
