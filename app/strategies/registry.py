...
# Aucune stratégie n'est exécutable sur BTCUSD ; les candidats BTC restent
# observation/SHADOW uniquement et n'atteignent jamais le routeur.
ALLOWED_BTC_EXECUTION_STRATEGIES = frozenset()
